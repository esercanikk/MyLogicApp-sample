...
; (function (window, document, $) {
    ...
    $(window).on("load", function () {
        var rtl
        var compactMenu = localStorage['compact'] === 'true'; // Set it to true, if you want default menu to be compact
    ...
    $(".search-input .input").on("keyup", function (e) {
        if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
            ...
            if (value != "") {
                ...
                $.ajax({
                    url: `/api/ui/getmenusearchresult?roles=${roles}&searchtext=${value}`,
                    method: "get",
                    success: function (res) {
                        ...
                        $("ul.search-list").html($startList) // Appending list to <ul>
                    }
                });
            } else {
                if (bookmark === true) {
